...
parser IngressParser(packet_in pkt,
    ...
    state start {
        ...
        md = (metadata_t){0, 0, 0, 0, 0, 0, 0, 0, 0};
...
control Ingress(inout headers_t hdr,
    ...
    table detect {
        ...
        actions = { flag_grayhole; flag_high_StNum; flag_injection; flag_inverse_replay; flag_masquerade_fake_normal; flag_poisoned_high_rate; no_attack; }
